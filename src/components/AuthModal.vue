...
.close-btn:hover { color: #e30613; }

.modal-header { text-align: center; margin-bottom: 30px; }
.modal-header h2 { color: #222; font-size: 1.8rem; margin-bottom: 8px; }
.modal-header p { color: #666; font-size: 0.9rem; line-height: 1.4; }
...
.input-icon { position: absolute; left: 12px; color: #aaa; }
.input-wrapper input {
  width: 100%;
...
.input-wrapper input:focus { border-color: #e30613; outline: none; }
...
.submit-btn:hover { background: #b00010; }

.modal-footer { text-align: center; margin-top: 25px; font-size: 0.9rem; color: #666; }
.modal-footer a { color: #e30613; font-weight: 600; text-decoration: none; }
